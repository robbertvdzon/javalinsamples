...
import com.dependencyinjection.DependencyInjectionApplication;
...
class JavalinBaseApplicationIT {
    private DependencyInjectionApplication application;

    @BeforeEach
    void before() {
        application = new DependencyInjectionApplication();
        application.start();
    }
